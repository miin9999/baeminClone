...
import aop.fastcampus.part06.chapter01.data.response.address.AddressInfoResponse
import aop.fastcampus.part06.chapter01.data.response.search.SearchResponse
import aop.fastcampus.part06.chapter01.data.url.Key
import aop.fastcampus.part06.chapter01.data.url.Url
...
//
    ...
    suspend fun getSearchLocationAround(
        @Query("appKey") appKey: String = Key.TMAP_API,
        @Query("version") version: Int = 1,
